...
import { ASTDidChangeParams, ASTDidChangeResponse, BallerinaExampleListParams,
    BallerinaExampleListResponse, BallerinaProject, DidOpenParams, GetASTParams, GetASTResponse, GetBallerinaProjectParams,
...
export class EmptyLanguageClient implements IBallerinaLangClient {
    ...
    public didOpen(params: DidOpenParams): void {
        // EMPTy
    }
